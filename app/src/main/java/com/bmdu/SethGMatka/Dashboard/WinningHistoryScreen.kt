...
import com.bmdu.SethGMatka.Model.WinningHistoryItem
import com.bmdu.SethGMatka.viewModel.WinningHistoryViewModel
        ...
        Box(
            ...
            when {
                ...
                // Data
                    ...
                    val totalWon = winningList.sumOf { it.winAmount }
    ...
    Card(
        ...
        Row(
            ...
            Column(horizontalAlignment = Alignment.End) {
                Text("+ ₹${item.winAmount}", fontWeight = FontWeight.Bold, fontSize = 16.sp, color = Color(0xFF2E7D32))
                Spacer(modifier = Modifier.height(4.dp))
                Box(
                    modifier = Modifier
