...
fun PrivacyPolicyScreen(navController: NavController) {
    ...
    val sections = listOf(
        ...
        PrivacySection(
            title = "9. Contact Us",
            content = "If you have any questions about this Privacy Policy, please contact us at support@dhanlaxmi.com or call us at +91 96743 32246."
        )
    )
    ...
    Scaffold(
        ...
        LazyColumn(
            ...
            item {
                Spacer(modifier = Modifier.height(8.dp))
                Text(
                    text = "© 2025 Dhanlaxmi. All rights reserved.",
                    color = Color.Gray,
                    fontSize = 12.sp,
                    modifier = Modifier
                        .fillMaxWidth()
